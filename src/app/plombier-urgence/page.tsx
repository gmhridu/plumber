...
export const metadata: Metadata = {
  title: 'Urgence Plombier - Intervention Immédiate 24/7',
  description: 'Besoin d\'un plombier en urgence ? Arrivée en 30 minutes. Disponible 24h/24 et 7j/7 pour tout dépannage plomberie.',
  alternates: {
...
export default function EmergencyPlumberPage() {
  const faq = [
    {
      ...
      answer: "Nous garantissons une arrivée en moins de 30 minutes après votre appel pour toutes les urgences en Île-de-France."
    },
    {
  ...
  return (
    <ServicePage
      title="Plombier d'Urgence – 24/7 Intervention Rapide"
